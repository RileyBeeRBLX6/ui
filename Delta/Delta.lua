...
if execvv ~= "1.3.658.460" and execvv ~= "1.4.658.460" then
...
local status, res1, res2 = pcall(function()
    ...
    local function C_21()
        ...
        onMessage = function(msg)
            DELTA["18"]["Text"] = msg -- notify user of status. 
        end
